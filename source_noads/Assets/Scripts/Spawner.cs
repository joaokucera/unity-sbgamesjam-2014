...
public class Spawner : MonoBehaviour
{
    ...
    private void CreateDamItem(Transform prefab)
    {
    ...
    private void CreateItem(Transform prefab)
    {
        ...
        if (followPlayer)
        {
            ...
            positionToSpawn.y = Random.Range(ScreenResolution.Instance.RiverBorders.yMin + prefab.renderer.bounds.size.x / 2,
                                             ScreenResolution.Instance.RiverBorders.yMax - prefab.renderer.bounds.size.y / 2);
        }
        ...
        {
            positionToSpawn.y += (positionToSpawn.y - yMinLimit);
        }
